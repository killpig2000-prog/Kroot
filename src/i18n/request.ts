...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  const namespaces = ['common', 'nav', 'onboarding', 'vocabulary', 'words', 'ui', 'listening', 'writing', 'pronunciation', 'landing', 'dashboard', 'reading', 'slang', 'tree', 'profile', 'shop', 'community', 'levelTest', 'grammarUi', 'hangul', 'auth', 'notFound', 'guide', 'error', 'tour'];
