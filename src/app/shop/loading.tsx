              ...
              <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_300px]">
                ...
                <div className="p-4 sm:p-5 min-w-0">
                  ...
                  <div className="grid grid-cols-[repeat(auto-fill,minmax(150px,1fr))] gap-2.5">
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div key={i} className="border border-line rounded-[12px] overflow-hidden bg-white">
                ...
                <div className="border-t lg:border-t-0 lg:border-l border-line bg-warm p-4">
                  ...
                  <div className="mx-auto max-w-[230px] bg-white border border-line p-1.5 pb-6 mb-3">
                    <div className="h-[180px] rounded-[9px] bg-warm-2" />
                  </div>

                  <div className="grid grid-cols-2 gap-1.5">
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div key={i} className="border border-line bg-white rounded-lg px-2 py-1.5">
                  ...
                  <div className="flex gap-2 mt-3">
                    ...
                    <div className="w-16 h-9 rounded-[10px] bg-white border border-line" />
                  </div>
