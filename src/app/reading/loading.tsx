      ...
      <div className="grid grid-cols-1 md:grid-cols-[clamp(200px,18%,280px)_minmax(0,1fr)] w-full min-h-screen">
        ...
        <main className="min-w-0 px-[clamp(18px,4vw,44px)] pt-6 pb-[100px] md:pb-[60px]">
          <div className="animate-pulse">
            ...
            <div className="h-3 w-72 rounded-full bg-[#F7F3E9] mb-6" />
            ...
            <div className="flex items-center gap-3.5 border-[1.5px] border-[#BFDBFE] bg-[#EFF6FF] rounded-[14px] px-5 py-4 mb-6 max-w-[720px]">
              <div className="w-10 h-10 rounded-[10px] bg-white border border-[#BFDBFE] flex-none" />
              <div className="flex-1 min-w-[170px]">
                <div className="h-3.5 w-40 rounded-full bg-[#BFDBFE]/60 mb-1.5" />
                <div className="h-2.5 w-28 rounded-full bg-[#BFDBFE]/40" />
              </div>
              <div className="h-3 w-14 rounded-full bg-[#BFDBFE]/60" />
            </div>
                ...
                >
                  <div className="flex items-center gap-3 px-5 py-3.5">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="h-2.5 w-48 rounded-full bg-[#F7F3E9]" />
                    </div>
                    <div className="flex-none flex items-center gap-2">
                      <div className="w-[74px] h-1.5 rounded-full bg-[#EFE9DC]" />
                      <div className="h-2.5 w-8 rounded-full bg-[#F3EEE2]" />
                    </div>
                  </div>
                  {gi === 0 && (
                    <div className="px-3.5 pb-3.5 pt-2 border-t border-dashed border-[#E3DDD0] grid gap-6 py-4">
                      {Array.from({ length: 3 }).map((_, i) => (
                        <div key={i} className={`flex items-center gap-3 ${i % 2 ? "flex-row-reverse text-right" : ""}`}>
                          <div className="w-11 h-11 rounded-full bg-[#EFF6FF] border border-[#BFDBFE] flex-none" />
