        ...
        <main className="min-w-0 px-[clamp(18px,4vw,44px)] pt-6 pb-[100px] xl:pb-[60px]">
          ...
          <div className="flex items-center justify-between gap-4 mb-[18px] flex-wrap">
            <h1 className="font-bold text-[22px] tracking-[-0.02em] flex items-center">
              <span className="inline-flex w-[30px] h-[30px] rounded-lg bg-[var(--tint-pink)] text-[var(--tint-pink-ink)] border border-[var(--tint-pink-line)] items-center justify-center kr text-[15px] mr-[9px]">
                슬
              </span>
              {tn("slang")}
            </h1>
