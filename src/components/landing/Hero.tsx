...
export default function Hero() {
  return (
    <header className="relative overflow-hidden bg-[#FDFBF7] text-center px-6 pt-[clamp(56px,9vw,96px)] pb-[clamp(72px,10vw,120px)]">
      ...
      <Polaroid scene="hanok" caption="북촌에서" tape="blue" className="hidden sm:block absolute left-[2%] top-[52px] w-[166px] h-[156px] -rotate-6" />
      <Polaroid scene="night" caption="첫 서울 밤" tape="yellow" className="hidden sm:block absolute left-[6%] bottom-[44px] w-[148px] h-[140px] rotate-3" />
      <Polaroid scene="food" caption="첫 떡볶이 🌶️" tape="pink" className="hidden sm:block absolute right-[2%] top-[46px] w-[170px] h-[158px] rotate-6" />
      <Polaroid scene="cafe" caption="카페 공부 ☕" tape="blue" className="hidden sm:block absolute right-[6%] bottom-[38px] w-[148px] h-[140px] -rotate-3" />
