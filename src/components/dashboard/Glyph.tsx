...
//
// The Settings page briefly had a dozen of these — one per row — before the
// rows lost their icons entirely (2026-09-10): a column of identical boxes
// beside a column of labels reads as decoration, not navigation. The pencil
// survived; it marks the one thing on that page you can edit in place.
//
