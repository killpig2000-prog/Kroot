  ...
  return (
    <div className="relative border border-[#ECD98A] bg-[#FEF9C3] px-5 py-[18px] mb-[30px] rotate-[0.4deg] shadow-[0_12px_24px_-14px_rgba(120,100,30,.4)]">
      ...
      <button
        ...
        className="absolute top-2.5 right-2.5 w-[26px] h-[26px] rounded-lg text-[13px] text-faint hover:bg-white hover:text-charcoal transition-colors"
      >
        ✕
      </button>
      ...
      <div className="flex items-center gap-4 flex-wrap">
        ...
        <Link
          href="/course"
          className="flex-none bg-success text-white rounded-[9px] px-[18px] py-2.5 text-[13.5px] font-bold shadow-[0_4px_0_#15803D] hover:translate-y-[2px] hover:shadow-[0_2px_0_#15803D] transition-all"
        >
          Open course →
        </Link>
      </div>
