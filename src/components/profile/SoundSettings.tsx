...
// Sound card on /profile: one switch for the app's feedback chimes (right,
// wrong, water, coins, level up…). Stored per device — sound is a device
// preference, not an account one. Speech (the Korean voice) is never gated
// here; it's learning content, not feedback.
export default function SoundSettings() {
  ...
  return (
    <div id="sound" className="border border-line rounded-[14px] px-[22px] py-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="flex-1 min-w-0">
          <b className="block text-[13.5px] font-semibold">{t("sfxTitle")}</b>
