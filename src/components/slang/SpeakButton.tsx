...
export default function SpeakButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center w-8 h-8 rounded-lg border border-line bg-cream text-[13px] transition-all hover:border-[var(--tint-pink-ink)] hover:bg-[var(--tint-pink)] hover:scale-110 ${className}`}
    >
      🔊
    </button>
  );
