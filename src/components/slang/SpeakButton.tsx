...
export default function SpeakButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center w-8 h-8 rounded-lg border border-line bg-white text-[13px] transition-all hover:border-[#C13E78] hover:bg-[#FDF2F8] hover:scale-110 ${className}`}
    >
      🔊
    </button>
  );
