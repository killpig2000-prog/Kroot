...
🌳 Level (Lv 1–50) — every lesson, quiz, and review earns XP. Your tree grows through seven looks as you level: seed → sprout → young tree → sturdy tree → grown tree → elder tree → the Guardian Tree at Lv 50. Levels get a little harder from Lv 21, the fifth look, and keep climbing from there. Every tenth level also drops 150 coins for the shop.
