...
export const SOUND_GROUPS: SoundGroup[] = [
  {
    ...
    items: [
      ...
      { kr: "얼굴", romanization: "eolgul", en: "face" },
    ],
  },
  {
    key: "tense",
  ...
  },
  {
    ...
    items: [
      { kr: "달리기", romanization: "dalligi", en: "running" },
      { kr: "탈출", romanization: "talchul", en: "escape" },
      { kr: "딸기", romanization: "ttalgi", en: "strawberry" },
      { kr: "도로", romanization: "doro", en: "road" },
      { kr: "토요일", romanization: "toyoil", en: "Saturday" },
      { kr: "또래", romanization: "ttorae", en: "peer, same age" },
    ],
  },
  {
    key: "triplet-p",
    title: "바 · 파 · 빠 — the ㅂ triplet",
    tip: "Lips together for all three. 불고기 (BBQ) is soft, 풀다 (untie) sprays air, 뿌리 (root) pops out under pressure. English 'b' and 'p' sit between the Korean sounds, so aim past them in both directions.",
    items: [
      { kr: "불고기", romanization: "bulgogi", en: "Korean BBQ" },
      { kr: "풀다", romanization: "pulda", en: "to untie / solve" },
      { kr: "뿌리", romanization: "ppuri", en: "root" },
      { kr: "방학", romanization: "banghak", en: "school vacation" },
      { kr: "팽이", romanization: "paengi", en: "spinning top" },
      { kr: "빵집", romanization: "ppangjip", en: "bakery" },
    ],
  },
  {
    key: "triplet-s",
    ...
    items: [
      ...
      { kr: "살구", romanization: "salgu", en: "apricot" },
      { kr: "쌀밥", romanization: "ssalbap", en: "cooked rice" },
      { kr: "시간", romanization: "sigan", en: "time" },
      { kr: "씨앗", romanization: "ssiat", en: "seed" },
    ],
  },
  {
    key: "eo-o",
  ...
  },
  {
    ...
    items: [
      { kr: "개미", romanization: "gaemi", en: "ant" },
      { kr: "게임", romanization: "geim", en: "game" },
      { kr: "내일", romanization: "naeil", en: "tomorrow" },
      { kr: "네모", romanization: "nemo", en: "square" },
      { kr: "새우", romanization: "saeu", en: "shrimp" },
      { kr: "세수", romanization: "sesu", en: "washing your face" },
    ],
  },
  {
    key: "y-vowels",
  ...
  },
  {
    ...
    items: [
      { kr: "김밥", romanization: "gimbap", en: "seaweed rice roll" },
      { kr: "생각", romanization: "saenggak", en: "a thought" },
      { kr: "다섯", romanization: "daseot", en: "five" },
      { kr: "등산", romanization: "deungsan", en: "hiking" },
      { kr: "봄바람", romanization: "bombaram", en: "spring breeze" },
      { kr: "한강", romanization: "hangang", en: "the Han River" },
    ],
  },
  {
    key: "batchim-seven",
    ...
    items: [
      { kr: "낮잠", romanization: "natjam", en: "nap" },
      { kr: "버섯", romanization: "beoseot", en: "mushroom" },
      { kr: "꽃병", romanization: "kkotbyeong", en: "flower vase" },
      { kr: "부엌", romanization: "bueok", en: "kitchen" },
      { kr: "나뭇잎", romanization: "namunnip", en: "tree leaf" },
      { kr: "밖에", romanization: "bakke", en: "outside" },
    ],
  },
  {
    key: "double-batchim",
