...
type PromptFields = Pick<RawPrompt, "prompt_en"> &
  Partial<Pick<RawPrompt, "prompt_es" | "prompt_ja" | "prompt_zh" | "prompt_vi">>;
type ExampleFields = Pick<RawPrompt, "example_en"> &
  Partial<Pick<RawPrompt, "example_es" | "example_ja" | "example_zh" | "example_vi">>;
type StimulusFields = Pick<RawPrompt, "stimulus_en"> &
  Partial<Pick<RawPrompt, "stimulus_es" | "stimulus_ja" | "stimulus_zh" | "stimulus_vi">>;
